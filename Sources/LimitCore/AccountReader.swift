...
public struct Account: Sendable, Equatable {
    ...
    /// Tanınmazsa nil: "Bilinmiyor" gibi dile bağlı bir metin buraya
    /// yazılsaydı buluta da `plan` olarak gidiyordu. Gösterimdeki karşılık
    /// arayüzde yerelleştiriliyor.
...
public struct AccountReader: Sendable {
    ...
    public func read() -> Account? {
        ...
        return Account(
            ...
            subscriptionStart: (oauth["subscriptionCreatedAt"] as? String).flatMap(ISO8601Parsing.date(from:)),
